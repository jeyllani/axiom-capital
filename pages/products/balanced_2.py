...
# --- Marketing Section ---
st.title("🚀 Global Dynamic Growth")
st.markdown("<h3 style='color: #94a3b8; font-weight: 400; margin-top: -10px;'>Active Capital Appreciation</h3>", unsafe_allow_html=True)
...
with col_m1:
    ...
    <div style="padding-right: 20px;">
        <p>
            The <b>Global Dynamic Growth</b> strategy is engineered for investors with a higher risk tolerance who aim for substantial capital appreciation. 
            Using a lower risk aversion parameter (Utility Maximization), it aggressively targets assets with strong upward momentum.
        </p>
        <p>
            This strategy accepts higher volatility in exchange for the potential of outsized returns, making it a powerful engine for long-term wealth accumulation.
        </p>
        <ul style="list-style-type: none; padding-left: 0;">
            <li style="margin-bottom: 10px;">✅ <b>High Conviction</b>: Allocates to high-beta sectors during bull markets.</li>
            <li style="margin-bottom: 10px;">✅ <b>Growth Focus</b>: Prioritizes total return over volatility minimization.</li>
            <li>✅ <b>Wealth Multiplier</b>: Designed to maximize the compounding effect over long horizons.</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    
    st.info("💡 **Investment Profile**: Growth-oriented investors willing to weather market swings for maximum potential. Horizon: 7+ Years.")

with col_m2:
    st.markdown("""
    <div class="marketing-card">
        <h4>Key Characteristics</h4>
        <div class="feature-item"><span class="feature-icon">🚀</span> Aggressive Growth</div>
        <div class="feature-item"><span class="feature-icon">📉</span> Low Risk Aversion</div>
        <div class="feature-item"><span class="feature-icon">🔄</span> Monthly Rebalancing</div>
        <div class="feature-item"><span class="feature-icon">💰</span> High Return Potential</div>
    </div>
    """, unsafe_allow_html=True)
...
# --- Action Section ---
if 'show_results_balanced_2' not in st.session_state:
    st.session_state.show_results_balanced_2 = False

col_btn1, col_btn2, col_btn3 = st.columns([1, 2, 1])
with col_btn2:
    if st.button("🚀 Simulate Historical Performance (2010-2024)", use_container_width=True, type="primary"):
        st.session_state.show_results_balanced_2 = True

if st.session_state.show_results_balanced_2:
    st.markdown("---")
    
    # Run Strategy (Cached in Session State)
    if 'strategy_results_balanced_2' not in st.session_state:
        with st.spinner("🔄 Optimizing Portfolio & Running Backtest..."):
            st.session_state.strategy_results_balanced_2 = run_strategy("Balanced Growth")
    
    results = st.session_state.strategy_results_balanced_2
    ...
    with tab1:
        ...
        fig.add_trace(go.Scatter(x=cum_ret_series.index, y=cum_ret_series, name='Growth Strategy', 
