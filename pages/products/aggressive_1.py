...
# --- Marketing Section ---
st.title("🚀 Global Dynamic Aggressive")
st.markdown("<h3 style='color: #94a3b8; font-weight: 400; margin-top: -10px;'>High Growth Potential</h3>", unsafe_allow_html=True)
...
with col_m1:
    ...
    <div style="padding-right: 20px;">
        <p>
            The <b>Global Dynamic Aggressive</b> strategy is built for investors who demand superior capital appreciation and are willing to accept significant market volatility. 
            Utilizing a low risk aversion parameter (Utility Maximization), it aggressively positions the portfolio to capture the full upside of equity markets.
        </p>
        <p>
            This strategy is not for the faint of heart. It is a high-octane engine designed to maximize long-term wealth through concentrated exposure to high-growth assets.
        </p>
        <ul style="list-style-type: none; padding-left: 0;">
            <li style="margin-bottom: 10px;">✅ <b>Maximum Exposure</b>: Fully invested in high-beta opportunities.</li>
            <li style="margin-bottom: 10px;">✅ <b>Aggressive Rebalancing</b>: Rapidly shifts capital to winning sectors.</li>
            <li>✅ <b>Adaptability</b>: Rebalances monthly to capture evolving market trends.</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    
    st.info("💡 **Investment Profile**: Aggressive investors with a long time horizon (10+ Years) and high risk tolerance.")

with col_m2:
    st.markdown("""
    <div class="marketing-card">
        <h4>Key Characteristics</h4>
        <div class="feature-item"><span class="feature-icon">🔥</span> High Risk / Reward</div>
        ...
        <div class="feature-item"><span class="feature-icon">🚀</span> Max Capital Growth</div>
    </div>
    """, unsafe_allow_html=True)
...
# --- Action Section ---
if 'show_results_aggressive_1' not in st.session_state:
    st.session_state.show_results_aggressive_1 = False

col_btn1, col_btn2, col_btn3 = st.columns([1, 2, 1])
with col_btn2:
    if st.button("🚀 Simulate Historical Performance (2010-2024)", use_container_width=True, type="primary"):
        st.session_state.show_results_aggressive_1 = True

if st.session_state.show_results_aggressive_1:
    st.markdown("---")
    
    # Run Strategy (Cached in Session State)
    if 'strategy_results_aggressive_1' not in st.session_state:
        with st.spinner("🔄 Optimizing Portfolio & Running Backtest..."):
            st.session_state.strategy_results_aggressive_1 = run_strategy("Aggressive Dynamic")
    
    results = st.session_state.strategy_results_aggressive_1
    ...
    with tab1:
        ...
        fig.add_trace(go.Scatter(x=cum_ret_series.index, y=cum_ret_series, name='Dynamic Aggressive', 
