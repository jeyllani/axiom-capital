...
# --- Marketing Section ---
st.title("🛡️ Global Low Volatility Core")
st.markdown("<h3 style='color: #94a3b8; font-weight: 400; margin-top: -10px;'>Systematic Capital Preservation</h3>", unsafe_allow_html=True)
...
with col_m1:
    ...
    <div style="padding-right: 20px;">
        <p>
            The <b>Global Low Volatility Core</b> strategy seeks to provide stable capital appreciation by minimizing portfolio variance. 
            Leveraging advanced covariance matrix optimization, the strategy systematically selects assets with historically low volatility and low correlation.
        </p>
        <p>
            This approach is designed to mitigate downside risk during market turbulence while maintaining exposure to long-term equity growth.
        </p>
        <ul style="list-style-type: none; padding-left: 0;">
            <li style="margin-bottom: 10px;">✅ <b>Risk Mitigation</b>: Focus on minimizing drawdown depth and duration.</li>
            <li style="margin-bottom: 10px;">✅ <b>Stability</b>: Engineered for a smoother equity curve compared to broad market indices.</li>
            <li>✅ <b>Compound Growth</b>: Disciplined participation in market appreciation.</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    
    st.info("💡 **Investment Profile**: Conservative investors seeking equity exposure with reduced volatility. Horizon: 3-5 Years.")

with col_m2:
    st.markdown("""
    <div class="marketing-card">
        <h4>Key Characteristics</h4>
        <div class="feature-item"><span class="feature-icon">📉</span> Min Global Variance</div>
        <div class="feature-item"><span class="feature-icon">🌍</span> Sector Diversified</div>
        <div class="feature-item"><span class="feature-icon">🔄</span> Monthly Rebalancing</div>
        <div class="feature-item"><span class="feature-icon">🛡️</span> Low Beta Profile</div>
    </div>
    """, unsafe_allow_html=True)
...
# --- Action Section ---
if 'show_results_defensive_1' not in st.session_state:
    st.session_state.show_results_defensive_1 = False

col_btn1, col_btn2, col_btn3 = st.columns([1, 2, 1])
with col_btn2:
    if st.button("🚀 Simulate Historical Performance (2010-2024)", use_container_width=True, type="primary"):
        st.session_state.show_results_defensive_1 = True

if st.session_state.show_results_defensive_1:
    st.markdown("---")
    
    # Run Strategy (Cached in Session State)
    if 'strategy_results_defensive_1' not in st.session_state:
        with st.spinner("🔄 Optimizing Portfolio & Running Backtest..."):
            st.session_state.strategy_results_defensive_1 = run_strategy("Defensive MinVol")
    
    results = st.session_state.strategy_results_defensive_1
    ...
    with tab1:
        ...
        fig.add_trace(go.Scatter(x=cum_ret_series.index, y=cum_ret_series, name='Defensive Strategy', 
