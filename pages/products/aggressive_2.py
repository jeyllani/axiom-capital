...
# --- Marketing Section ---
st.title("🔥 Global High Octane")
st.markdown("<h3 style='color: #94a3b8; font-weight: 400; margin-top: -10px;'>Maximum Power</h3>", unsafe_allow_html=True)
...
with col_m1:
    ...
    <div style="padding-right: 20px;">
        <p>
            The <b>Global High Octane</b> strategy pushes the boundaries of growth investing. 
            With an extremely low risk aversion parameter (Utility Maximization), it seeks to identify and capitalize on the most explosive trends in the market.
        </p>
        <p>
            This portfolio is concentrated in high-beta, high-volatility assets that have the potential to deliver exponential returns during bull markets.
        </p>
        <ul style="list-style-type: none; padding-left: 0;">
            <li style="margin-bottom: 10px;">✅ <b>Aggressive Allocation</b>: Unapologetic focus on high-risk, high-reward sectors.</li>
            <li style="margin-bottom: 10px;">✅ <b>Momentum Capture</b>: Designed to ride the steepest upward trends.</li>
            <li>✅ <b>Speculative Growth</b>: Targets assets with the highest expected returns.</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    
    st.info("💡 **Investment Profile**: Speculative investors seeking maximum capital appreciation. Horizon: 10+ Years.")

with col_m2:
    st.markdown("""
    <div class="marketing-card">
        <h4>Key Characteristics</h4>
        <div class="feature-item"><span class="feature-icon">⚡</span> Ultra-Aggressive</div>
        <div class="feature-item"><span class="feature-icon">📉</span> Minimal Risk Aversion</div>
        <div class="feature-item"><span class="feature-icon">🔄</span> Monthly Rebalancing</div>
        <div class="feature-item"><span class="feature-icon">🚀</span> Exponential Potential</div>
    </div>
    """, unsafe_allow_html=True)
...
# --- Action Section ---
if 'show_results_aggressive_2' not in st.session_state:
    st.session_state.show_results_aggressive_2 = False

col_btn1, col_btn2, col_btn3 = st.columns([1, 2, 1])
with col_btn2:
    if st.button("🚀 Simulate Historical Performance (2010-2024)", use_container_width=True, type="primary"):
        st.session_state.show_results_aggressive_2 = True

if st.session_state.show_results_aggressive_2:
    st.markdown("---")
    
    # Run Strategy (Cached in Session State)
    if 'strategy_results_aggressive_2' not in st.session_state:
        with st.spinner("🔄 Optimizing Portfolio & Running Backtest..."):
            st.session_state.strategy_results_aggressive_2 = run_strategy("Aggressive HighOctane")
    
    results = st.session_state.strategy_results_aggressive_2
    ...
    with tab1:
        ...
        fig.add_trace(go.Scatter(x=cum_ret_series.index, y=cum_ret_series, name='High Octane Strategy', 
